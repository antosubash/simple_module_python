...
def _bootstrap_eager_celery() -> None:
    ...
    background of every suite. ``setdefault``, so a test that wants the
    transport (``modules/background_tasks/tests/test_invalidation.py``) can set
    the variable and get it.
    """
