...
function Edit() {
  ...
  return (
    <PageShell
      ...
      back="/admin/users/"
      leading={
        <span className="inline-flex h-13 w-13 shrink-0 items-center justify-center rounded-full bg-primary-600/10 text-lg font-bold text-primary-700 font-[var(--font-display)]">
