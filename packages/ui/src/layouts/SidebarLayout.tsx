...
export function SidebarLayout({ children, menuKey, theme, headerSlot, footerNavSlot }: SidebarLayoutProps) {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className={`sticky top-0 z-40 flex h-14 items-center gap-3 ${theme.sidebarBg} px-4 lg:hidden`}>
                <button
                ...
                <Link href="/dashboard" className="flex items-center gap-2">
                    <div className={`w-7 h-7 rounded-md ${theme.accentColor} flex items-center justify-center`}>
            ...
            <aside className={`fixed inset-y-0 left-0 z-50 w-64 ${theme.sidebarBg} flex flex-col border-r border-gray-800 transition-transform duration-200 ease-in-out lg:translate-x-0 lg:z-30 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                <div className="h-14 lg:h-16 flex items-center justify-between px-4 lg:px-6 border-b border-white/10">
                    <Link href="/dashboard" className="flex items-center gap-2">
                        <div className={`w-8 h-8 rounded-lg ${theme.accentColor} flex items-center justify-center`}>
