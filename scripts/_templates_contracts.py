...
def schemas_py(ctx: ScaffoldContext) -> str:
    return f'''\
        """Pydantic DTOs for the {ctx.class_name} module."""
        ...
        class {ctx.singular_class}Out(BaseModel):
        ...
        class {ctx.singular_class}Create(BaseModel):
        ...
        class {ctx.singular_class}Update(BaseModel):
